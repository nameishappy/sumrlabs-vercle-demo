import { getTermsOfUsePageData } from "@/sanity/lib/queries";
import React from "react";

const page = async () => {
  const policyPageData = await getTermsOfUsePageData();
  ...
  return (
    <>
      <div className="flex flex-col w-full h-[fit] justify-center pt-[18vh] py-[2vh]  top-0 z-30">
        <p className="text-center text-black lg:text-2xl md:text-xl font-semibold justify-end px-4 sm:px-8">
          {policyTitle}
        </p>
      </div>
